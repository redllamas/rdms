...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { body_material: @variant.body_material, product_id: @variant.product_id, size_mm: @variant.size_mm } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { body_material: @variant.body_material, product_id: @variant.product_id, size_mm: @variant.size_mm } }
